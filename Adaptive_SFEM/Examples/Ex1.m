...
%Plot the L2 Norm for a set of small Tolerances
A = struct2cell(load('OUTPUTforTOL05_04_03_02_01_005_0035_002.mat')); Z = A{1};
...
figure;
stairs(t,numb_nodes,'k','LineWidth',1.5)
ylabel('# of Nodes')
xlabel('t')
...
plot(t,errM,'k')
ylabel({'Approximation to $\|e(t_j)\|$'},'Interpreter','latex')
xlabel('t')
...
%% To get a PDF of the same size as Fig
% set(gcf,'Units','inches');
% screenposition = get(gcf,'Position');
% set(gcf,...
%     'PaperPosition',[0 0 screenposition(3:4)],...
%     'PaperSize',[screenposition(3:4)]);
% print -dpdf -painters NamePDF
